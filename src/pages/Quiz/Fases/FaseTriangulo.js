...
import premio from '../../../images/icons/terceiro.svg'
...
export default function Quiz() {
  ...
  const[nome_emblema,setNomeEmblema]= useState("Corajoso");
  const[fase_emblema,setFaseEmblema]= useState("Triângulo");
  const[etapa_desafio,setEtapaDesafio]= useState("Triângulo");
  ...
  useEffect(() => {
    async function getQuestions() {
      ...
      try {
        const resposta = await api.get('/faseTriangulo');
     ...
     items-center h-screen">
       ...
       {  questions.length > 0 ? 
          ...
          <CardContent className={classes.conteudo}>
            ...
            <Typography variant="h3" color="textSecondary" component="h5">
              Parabéns! Você concluiu a Fase do Triângulo.
        ...
        <Card className={classes.root}>
          ...
          />
           <Typography variant="h3" color="textSecondary" component="h5"className={classes.titulo}>
              Clique no Botão para adicionar o emblema Triângulo!
            </Typography>
            <CardContent className={classes.conteudoEmblema}>
             <form onSubmit={adicionarEmblema} > 
                ...
                <Button type='submit' className={classes.bnt1}>Emblema Corajoso</Button>
              </form> 
            </CardContent>
          </Card>
          </Grid>
