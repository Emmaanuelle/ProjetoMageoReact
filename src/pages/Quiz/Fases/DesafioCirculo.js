...
export default function Quiz() {
  ...
  useEffect(() => {
    async function getQuestions() {
      try {
        const resposta = await api.get('/desafioCirculo');
     ...
     items-center h-screen">
       ...
       {  desafio.length > 0 ? 
          ...
          <CardContent className={classes.conteudo}>
            ...
            <Typography variant="h3" color="textSecondary" component="h5">
              Parabéns! Você concluiu o Desafio da Fase Círculo.
          </Typography>
          <Typography  variant="h3" color="textSecondary" component="h5">
           Pontos:{pontos}!
          </Typography>
          ...
          <form onSubmit={cadastrarRanking} >
            ...
            <Button type='submit'href="/escolherFases" className={classes.bnt}>Página Inicial</Button>
          </form>
          </CardContent>
        </Card>
