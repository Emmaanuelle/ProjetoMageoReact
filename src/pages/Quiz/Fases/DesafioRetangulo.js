...
export default function Quiz() {
  ...
  const[nome_emblema,setNomeEmblema]= useState("Medalha Desafio Retangulo");
  ...
  useEffect(() => {
    async function getQuestions() {
      try {
        const resposta = await api.get('/desafioRetangulo');
     ...
     items-center h-screen">
       ...
       {  desafio.length > 0 ? 
          ...
          <CardContent className={classes.conteudo}>
            ...
            <Typography variant="h3" color="textSecondary" component="h5">
              Parabéns! Você concluiuo Desafio da Fase Retângulo.
          </Typography>
          <Typography  variant="h3" color="textSecondary" component="h5">
           Pontos:{pontos}!
          </Typography>
